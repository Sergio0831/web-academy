...
<main>
			...
			<div class="row align-items-center">
				...
				<div class="col-lg-7">
					<div class="text-left mb-4">
						<h3 class="h1">Innovative Way To Learn</h3>
					</div>
	...
	<!-- About End -->
	<!-- Registration Start -->
	<section class="container-fluid bg-registration py-5">
		<div class="container py-5">
			<div class="row align-items-center">
				<div class="col-lg-7 mb-5 mb-lg-0">
					<div class="mb-4">
						<h2 class="h5 text-primary text-uppercase mb-3" style="letter-spacing: 5px;">Need Any Courses
						</h2>
						<h3 class="h1 text-white">30% Off For New Students</h3>
					</div>
				...
				<div class="col-lg-5">
					<div class="card border-0">
						<div class="card-header bg-light text-center p-4">
							<h3 class="h1 m-0 font-weight-bold">Sign Up Now</h3>
						</div>
	...
	<section class="container-fluid py-5">
		<div class="container py-5">
			<div class="text-center mb-5">
				<h2 class="h5 text-primary text-uppercase mb-3" style="letter-spacing: 5px;">Testimonial</h2>
				<h3 class="h1 font-weight-bold">What Say Our Students</h3>
			</div>
